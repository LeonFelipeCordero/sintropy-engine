...
class ProducerRepository(
    ...
    fun findAll(): List<Producer> {
        return context.selectFrom(PRODUCERS).fetchInto(Producer::class.java)
    }
    ...
    fun deleteAll() {
        context.deleteFrom(PRODUCERS).execute()
    }
}