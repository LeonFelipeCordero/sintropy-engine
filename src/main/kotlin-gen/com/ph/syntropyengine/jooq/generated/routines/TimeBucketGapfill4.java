...
public class TimeBucketGapfill4 extends AbstractRoutine<LocalDate> {
     ...
     */
    public static final Parameter<LocalDate> START = Internal.createParameter("start", SQLDataType.LOCALDATE.defaultValue(DSL.field(DSL.raw("NULL::date"), SQLDataType.LOCALDATE)), true, false);

    /**
     * The parameter <code>public.time_bucket_gapfill.finish</code>.
     */
    public static final Parameter<LocalDate> FINISH = Internal.createParameter("finish", SQLDataType.LOCALDATE.defaultValue(DSL.field(DSL.raw("NULL::date"), SQLDataType.LOCALDATE)), true, false);

    /**
     * Create a new routine call instance
     */
    public TimeBucketGapfill4() {
        super("time_bucket_gapfill", Public.PUBLIC, SQLDataType.LOCALDATE);
