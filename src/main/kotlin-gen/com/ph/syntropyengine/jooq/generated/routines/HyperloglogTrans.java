...
public class HyperloglogTrans extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>public.hyperloglog_trans.size</code>.
     */
     ...
     */
    public HyperloglogTrans() {
        super("hyperloglog_trans", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
