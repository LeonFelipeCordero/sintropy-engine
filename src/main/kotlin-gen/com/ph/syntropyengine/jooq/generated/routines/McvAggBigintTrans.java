...
public class McvAggBigintTrans extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>public.mcv_agg_bigint_trans.n</code>.
     */
    public static final Parameter<Integer> N = Internal.createParameter("n", SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.mcv_agg_bigint_trans.value</code>.
     */
     ...
     */
    public McvAggBigintTrans() {
        super("mcv_agg_bigint_trans", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
