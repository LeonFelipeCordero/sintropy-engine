...
public class TimeBucketGapfill5 extends AbstractRoutine<LocalDateTime> {
     ...
     */
    public static final Parameter<LocalDateTime> START = Internal.createParameter("start", SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("NULL::timestamp without time zone"), SQLDataType.LOCALDATETIME)), true, false);

    /**
     * The parameter <code>public.time_bucket_gapfill.finish</code>.
     */
    public static final Parameter<LocalDateTime> FINISH = Internal.createParameter("finish", SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("NULL::timestamp without time zone"), SQLDataType.LOCALDATETIME)), true, false);

    /**
     * Create a new routine call instance
     */
    public TimeBucketGapfill5() {
        super("time_bucket_gapfill", Public.PUBLIC, SQLDataType.LOCALDATETIME(6));
