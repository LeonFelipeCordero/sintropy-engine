...
public class AddDimension extends TableImpl<AddDimensionRecord> {
     ...
     */
    public final TableField<AddDimensionRecord, String> SCHEMA_NAME = createField(DSL.name("schema_name"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>public.add_dimension.table_name</code>.
     */
    public final TableField<AddDimensionRecord, String> TABLE_NAME = createField(DSL.name("table_name"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>public.add_dimension.column_name</code>.
     */
    public final TableField<AddDimensionRecord, String> COLUMN_NAME = createField(DSL.name("column_name"), SQLDataType.VARCHAR, this, "");
