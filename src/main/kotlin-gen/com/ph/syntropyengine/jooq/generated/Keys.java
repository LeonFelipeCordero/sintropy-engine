...
public class Keys {
    ...
    public static final UniqueKey<MessagesRecord> MESSAGES_MESSAGE_ID_TIMESTAMP_OK = Internal.createUniqueKey(Messages.MESSAGES, DSL.name("messages_message_id_timestamp_ok"), new TableField[] { Messages.MESSAGES.MESSAGE_ID, Messages.MESSAGES.TIMESTAMP, Messages.MESSAGES.CHANNEL_ID }, true);
