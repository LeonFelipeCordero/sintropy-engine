...
public class PercentileAggTrans extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>public.percentile_agg_trans.value</code>.
     */
     ...
     */
    public PercentileAggTrans() {
        super("percentile_agg_trans", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
